 ...
 *
 *  It has been AutoGen-ed  June 18, 2013 at 09:43:44 PM by AutoGen 5.17.4
...
#define zLicenseDescrip (xml2ag_opt_strs+270)
 ...
 */
static char const xml2ag_opt_strs[2942] =
/*     0 */ "xml2ag (GNU AutoGen) 5.17.4\n"
            "Copyright (C) 1992-2013 Bruce Korb, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   270 */ "xml2ag is free software: you can redistribute it and/or modify it under the\n"
            ...
            "You should have received a copy of the GNU General Public License along\n"
            "with this program.  If not, see <http://www.gnu.org/licenses/>.\n\0"
/*   871 */ "All other options are derived from autogen:\0"
/*   915 */ "Output file in lieu of AutoGen processing\0"
/*   957 */ "OUTPUT\0"
/*   964 */ "output\0"
/*   971 */ "All other options:\0"
/*   990 */ "Search for templates in DIR\0"
/*  1018 */ "TEMPL_DIRS\0"
/*  1029 */ "templ-dirs\0"
/*  1040 */ "Use TPL-FILE for the template\0"
/*  1070 */ "OVERRIDE_TPL\0"
/*  1083 */ "override-tpl\0"
/*  1096 */ "Load AutoGen macros from TPL-FILE (deprecated)\0"
/*  1143 */ "LIB_TEMPLATE\0"
/*  1156 */ "lib-template\0"
/*  1169 */ "Read definitions from FILE\0"
/*  1196 */ "DEFINITIONS\0"
/*  1208 */ "definitions\0"
/*  1220 */ "name or path name of shell to use\0"
/*  1254 */ "SHELL\0"
/*  1260 */ "shell\0"
/*  1266 */ "Do not use in-mem streams\0"
/*  1292 */ "NO_FMEMOPEN\0"
/*  1304 */ "no-fmemopen\0"
/*  1316 */ "characters considered equivalent\0"
/*  1349 */ "EQUATE\0"
/*  1356 */ "equate\0"
/*  1363 */ "Specify NAME as the base name for output\0"
/*  1404 */ "BASE_NAME\0"
/*  1414 */ "base-name\0"
/*  1424 */ "set mod times to latest source\0"
/*  1455 */ "SOURCE_TIME\0"
/*  1467 */ "source-time\0"
/*  1479 */ "Allow output files to be writable\0"
/*  1513 */ "WRITABLE\0"
/*  1522 */ "not-writable\0"
/*  1535 */ "not\0"
/*  1539 */ "Limit on increment loops\0"
/*  1564 */ "LOOP_LIMIT\0"
/*  1575 */ "loop-limit\0"
/*  1586 */ "Limit server shell operations to SECONDS\0"
/*  1627 */ "TIMEOUT\0"
/*  1635 */ "timeout\0"
/*  1643 */ "tracing level of detail\0"
/*  1667 */ "TRACE\0"
/*  1673 */ "trace\0"
/*  1679 */ "tracing output file or filter\0"
/*  1709 */ "TRACE_OUT\0"
/*  1719 */ "trace-out\0"
/*  1729 */ "Show the definition tree\0"
/*  1754 */ "SHOW_DEFS\0"
/*  1764 */ "show-defs\0"
/*  1774 */ "Show the definitions used\0"
/*  1800 */ "USED_DEFINES\0"
/*  1813 */ "used-defines\0"
/*  1826 */ "Leave a core dump on a failure exit\0"
/*  1862 */ "CORE\0"
/*  1867 */ "core\0"
/*  1872 */ "Skip the file with this SUFFIX\0"
/*  1903 */ "SKIP_SUFFIX\0"
/*  1915 */ "skip-suffix\0"
/*  1927 */ "specify this output suffix\0"
/*  1954 */ "SELECT_SUFFIX\0"
/*  1968 */ "select-suffix\0"
/*  1982 */ "name to add to definition list\0"
/*  2013 */ "DEFINE\0"
/*  2020 */ "define\0"
/*  2027 */ "definition list removal pattern\0"
/*  2059 */ "UNDEFINE\0"
/*  2068 */ "undefine\0"
/*  2077 */ "emit make dependency file\0"
/*  2103 */ "MAKE_DEP\0"
/*  2112 */ "make-dep\0"
/*  2121 */ "display extended usage information and exit\0"
/*  2165 */ "help\0"
/*  2170 */ "extended usage information passed thru pager\0"
/*  2215 */ "more-help\0"
/*  2225 */ "output version information and exit\0"
/*  2261 */ "version\0"
/*  2269 */ "XML2AG\0"
/*  2276 */ "xml2ag (GNU AutoGen) - XML to AutoGen Definiton Converter - Ver. 5.17.4\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ <def-file> ]\n\0"
/*  2421 */ "autogen-users@lists.sourceforge.net\0"
/*  2457 */ "This program will convert any arbitrary XML file into equivalent AutoGen\n"
            "definitions, and invoke AutoGen.\n\0"
/*  2564 */ "The template will be derived from either: * the ``--override-tpl'' command\n"
...
/*  2833 */ "xml2ag (GNU AutoGen) 5.17.4\0"
/*  2861 */ "nothing\0"
/*  2869 */ "debug-message\0"
/*  2883 */ "server-shell\0"
/*  2896 */ "templates\0"
/*  2906 */ "block-macros\0"
/*  2919 */ "expressions\0"
...
#define THE_XML2AG_OPTION_DESC      (xml2ag_opt_strs+871)
...
#define OUTPUT_DESC      (xml2ag_opt_strs+915)
/** Upper-cased name for the output option */
#define OUTPUT_NAME      (xml2ag_opt_strs+957)
/** Name string for the output option */
#define OUTPUT_name      (xml2ag_opt_strs+964)
...
#define AUTOGEN_OPTIONS_DESC      (xml2ag_opt_strs+971)
...
#define TEMPL_DIRS_DESC      (xml2ag_opt_strs+990)
/** Upper-cased name for the templ-dirs option */
#define TEMPL_DIRS_NAME      (xml2ag_opt_strs+1018)
/** Name string for the templ-dirs option */
#define TEMPL_DIRS_name      (xml2ag_opt_strs+1029)
...
#define OVERRIDE_TPL_DESC      (xml2ag_opt_strs+1040)
/** Upper-cased name for the override-tpl option */
#define OVERRIDE_TPL_NAME      (xml2ag_opt_strs+1070)
/** Name string for the override-tpl option */
#define OVERRIDE_TPL_name      (xml2ag_opt_strs+1083)
...
#define LIB_TEMPLATE_DESC      (xml2ag_opt_strs+1096)
/** Upper-cased name for the lib-template option */
#define LIB_TEMPLATE_NAME      (xml2ag_opt_strs+1143)
/** Name string for the lib-template option */
#define LIB_TEMPLATE_name      (xml2ag_opt_strs+1156)
/** Compiled in flag settings for the lib-template option */
#define LIB_TEMPLATE_FLAGS     (OPTST_DISABLED | OPTST_STACKED | OPTST_DEPRECATED \
        | OPTST_SET_ARGTYPE(OPARG_TYPE_STRING))
...
#define DEFINITIONS_DESC      (xml2ag_opt_strs+1169)
/** Upper-cased name for the definitions option */
#define DEFINITIONS_NAME      (xml2ag_opt_strs+1196)
/** Name string for the definitions option */
#define DEFINITIONS_name      (xml2ag_opt_strs+1208)
...
#define SHELL_DESC      (xml2ag_opt_strs+1220)
/** Upper-cased name for the shell option */
#define SHELL_NAME      (xml2ag_opt_strs+1254)
/** Name string for the shell option */
#define SHELL_name      (xml2ag_opt_strs+1260)
...
#define NO_FMEMOPEN_DESC      (xml2ag_opt_strs+1266)
/** Upper-cased name for the no-fmemopen option */
#define NO_FMEMOPEN_NAME      (xml2ag_opt_strs+1292)
/** Name string for the no-fmemopen option */
#define NO_FMEMOPEN_name      (xml2ag_opt_strs+1304)
...
#define EQUATE_DESC      (xml2ag_opt_strs+1316)
/** Upper-cased name for the equate option */
#define EQUATE_NAME      (xml2ag_opt_strs+1349)
/** Name string for the equate option */
#define EQUATE_name      (xml2ag_opt_strs+1356)
...
#define BASE_NAME_DESC      (xml2ag_opt_strs+1363)
/** Upper-cased name for the base-name option */
#define BASE_NAME_NAME      (xml2ag_opt_strs+1404)
/** Name string for the base-name option */
#define BASE_NAME_name      (xml2ag_opt_strs+1414)
...
#define SOURCE_TIME_DESC      (xml2ag_opt_strs+1424)
/** Upper-cased name for the source-time option */
#define SOURCE_TIME_NAME      (xml2ag_opt_strs+1455)
/** Name string for the source-time option */
#define SOURCE_TIME_name      (xml2ag_opt_strs+1467)
...
#define WRITABLE_DESC      (xml2ag_opt_strs+1479)
/** Upper-cased name for the writable option */
#define WRITABLE_NAME      (xml2ag_opt_strs+1513)
/** disablement name for the writable option */
#define NOT_WRITABLE_name  (xml2ag_opt_strs+1522)
/** disablement prefix for the writable option */
#define NOT_WRITABLE_PFX   (xml2ag_opt_strs+1535)
...
#define LOOP_LIMIT_DESC      (xml2ag_opt_strs+1539)
/** Upper-cased name for the loop-limit option */
#define LOOP_LIMIT_NAME      (xml2ag_opt_strs+1564)
/** Name string for the loop-limit option */
#define LOOP_LIMIT_name      (xml2ag_opt_strs+1575)
...
#define TIMEOUT_DESC      (xml2ag_opt_strs+1586)
/** Upper-cased name for the timeout option */
#define TIMEOUT_NAME      (xml2ag_opt_strs+1627)
/** Name string for the timeout option */
#define TIMEOUT_name      (xml2ag_opt_strs+1635)
...
#define TRACE_DESC      (xml2ag_opt_strs+1643)
/** Upper-cased name for the trace option */
#define TRACE_NAME      (xml2ag_opt_strs+1667)
/** Name string for the trace option */
#define TRACE_name      (xml2ag_opt_strs+1673)
...
#define TRACE_OUT_DESC      (xml2ag_opt_strs+1679)
/** Upper-cased name for the trace-out option */
#define TRACE_OUT_NAME      (xml2ag_opt_strs+1709)
/** Name string for the trace-out option */
#define TRACE_OUT_name      (xml2ag_opt_strs+1719)
...
#define SHOW_DEFS_DESC      (xml2ag_opt_strs+1729)
/** Upper-cased name for the show-defs option */
#define SHOW_DEFS_NAME      (xml2ag_opt_strs+1754)
/** Name string for the show-defs option */
#define SHOW_DEFS_name      (xml2ag_opt_strs+1764)
...
#define USED_DEFINES_DESC      (xml2ag_opt_strs+1774)
/** Upper-cased name for the used-defines option */
#define USED_DEFINES_NAME      (xml2ag_opt_strs+1800)
/** Name string for the used-defines option */
#define USED_DEFINES_name      (xml2ag_opt_strs+1813)
...
#define CORE_DESC      (xml2ag_opt_strs+1826)
/** Upper-cased name for the core option */
#define CORE_NAME      (xml2ag_opt_strs+1862)
/** Name string for the core option */
#define CORE_name      (xml2ag_opt_strs+1867)
...
#define SKIP_SUFFIX_DESC      (xml2ag_opt_strs+1872)
/** Upper-cased name for the skip-suffix option */
#define SKIP_SUFFIX_NAME      (xml2ag_opt_strs+1903)
/** Name string for the skip-suffix option */
#define SKIP_SUFFIX_name      (xml2ag_opt_strs+1915)
...
#define SELECT_SUFFIX_DESC      (xml2ag_opt_strs+1927)
/** Upper-cased name for the select-suffix option */
#define SELECT_SUFFIX_NAME      (xml2ag_opt_strs+1954)
/** Name string for the select-suffix option */
#define SELECT_SUFFIX_name      (xml2ag_opt_strs+1968)
...
#define DEFINE_DESC      (xml2ag_opt_strs+1982)
/** Upper-cased name for the define option */
#define DEFINE_NAME      (xml2ag_opt_strs+2013)
/** Name string for the define option */
#define DEFINE_name      (xml2ag_opt_strs+2020)
...
#define UNDEFINE_DESC      (xml2ag_opt_strs+2027)
/** Upper-cased name for the undefine option */
#define UNDEFINE_NAME      (xml2ag_opt_strs+2059)
/** Name string for the undefine option */
#define UNDEFINE_name      (xml2ag_opt_strs+2068)
...
#define MAKE_DEP_DESC      (xml2ag_opt_strs+2077)
/** Upper-cased name for the make-dep option */
#define MAKE_DEP_NAME      (xml2ag_opt_strs+2103)
/** Name string for the make-dep option */
#define MAKE_DEP_name      (xml2ag_opt_strs+2112)
 ...
 */
#define HELP_DESC       (xml2ag_opt_strs+2121)
#define HELP_name       (xml2ag_opt_strs+2165)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (xml2ag_opt_strs+2170)
#define MORE_HELP_name  (xml2ag_opt_strs+2215)
...
#endif
#define VER_DESC        (xml2ag_opt_strs+2225)
#define VER_name        (xml2ag_opt_strs+2261)
/**
...
static tOptDesc optDesc[OPTION_CT] = {
  ...
  {  /* entry idx, value */ 5, VALUE_OPT_LIB_TEMPLATE,
     /* equiv idx, value */ 5, VALUE_OPT_LIB_TEMPLATE,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, NOLIMIT, 0,
  ...
  {  /* entry idx, value */ 6, VALUE_OPT_DEFINITIONS,
     /* equiv idx, value */ 6, VALUE_OPT_DEFINITIONS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 10, VALUE_OPT_BASE_NAME,
     /* equiv idx, value */ 10, VALUE_OPT_BASE_NAME,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 11, VALUE_OPT_SOURCE_TIME,
     /* equiv idx, value */ 11, VALUE_OPT_SOURCE_TIME,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 24, VALUE_OPT_MAKE_DEP,
     /* equiv idx, value */ 24, VALUE_OPT_MAKE_DEP,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, NOLIMIT, 0,
...
#define zPROGNAME       (xml2ag_opt_strs+2269)
/** Reference to the title line for xml2ag usage. */
#define zUsageTitle     (xml2ag_opt_strs+2276)
...
#define zBugsAddr       (xml2ag_opt_strs+2421)
/** Clarification/explanation of what xml2ag does. */
#define zExplain        (xml2ag_opt_strs+2457)
/** Extra detail explaining what xml2ag does. */
#define zDetail         (xml2ag_opt_strs+2564)
/** The full version string for xml2ag. */
#define zFullVersion    (xml2ag_opt_strs+2833)
...
{
    optionUsage(&xml2agOptions, XML2AG_EXIT_SUCCESS);
    /* NOTREACHED */
    (void)pOptDesc;
    (void)pOptions;
}
...
/* extracted from optmain.tlib near line 954 */
    static char const * const names[7] = {
        xml2ag_opt_strs+2861, xml2ag_opt_strs+2869, xml2ag_opt_strs+2883,
        xml2ag_opt_strs+2896, xml2ag_opt_strs+2906, xml2ag_opt_strs+2919,
        xml2ag_opt_strs+2931 };
 ...
 * xml2ag program.  These translations happen upon entry
 * to optionProcess().
 */
#include <stdio.h>
#include <stdlib.h>
...
/**
 * Translate all the translatable strings in the xml2agOptions
 * structure defined above.  This is done only once.
 */
static void
translate_option_strings(void)
{
    tOptions * const opts = &xml2agOptions;
...
static void bogus_function(void) {
  /* TRANSLATORS:
     ...
     in the xml2agOptions structure noted in the comments below.  The
     literal text is defined in xml2ag_opt_strs.
   
     NOTE: the strings below are segmented with respect to the source string
     xml2ag_opt_strs.  The strings above are handed off for translation
   ...
   */
  /* referenced via xml2agOptions.pzCopyright */
  puts(_("xml2ag (GNU AutoGen) 5.17.4\n\
Copyright (C) 1992-2013 Bruce Korb, all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the GNU General Public License,\n\
version 3 or later <http://gnu.org/licenses/gpl.html>\n"));

  /* referenced via xml2agOptions.pzCopyNotice */
  puts(_("xml2ag is free software: you can redistribute it and/or modify it under the\n\
terms of the GNU General Public License as published by the Free Software\n\
Foundation, either version 3 of the License, or (at your option) any later\n\
version.\n\n"));
  puts(_("xml2ag is distributed in the hope that it will be useful, but WITHOUT ANY\n\
WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS\n\
FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more\n\
details.\n\n"));
...
with this program.  If not, see <http://www.gnu.org/licenses/>.\n"));
  ...
  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("All other options are derived from autogen:"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Output file in lieu of AutoGen processing"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("All other options:"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Search for templates in DIR"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Use TPL-FILE for the template"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Load AutoGen macros from TPL-FILE (deprecated)"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Read definitions from FILE"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("name or path name of shell to use"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Do not use in-mem streams"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("characters considered equivalent"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Specify NAME as the base name for output"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("set mod times to latest source"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Allow output files to be writable"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Limit on increment loops"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Limit server shell operations to SECONDS"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("tracing level of detail"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("tracing output file or filter"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Show the definition tree"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Show the definitions used"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Leave a core dump on a failure exit"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("Skip the file with this SUFFIX"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("specify this output suffix"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("name to add to definition list"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("definition list removal pattern"));

  /* referenced via xml2agOptions.pOptDesc->pzText */
  puts(_("emit make dependency file"));
  ...
  /* referenced via xml2agOptions.pzUsageTitle */
  puts(_("xml2ag (GNU AutoGen) - XML to AutoGen Definiton Converter - Ver. 5.17.4\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ <def-file> ]\n"));

  /* referenced via xml2agOptions.pzExplain */
  puts(_("This program will convert any arbitrary XML file into equivalent AutoGen\n\
definitions, and invoke AutoGen.\n"));

  /* referenced via xml2agOptions.pzDetail */
  puts(_("The template will be derived from either: * the ``--override-tpl'' command\n\
line option * a top level XML attribute named, \"template\"\n\n"));
  puts(_("The ``base-name'' for the output will similarly be either: * the\n\
``--base-name'' command line option * the base name of the .xml file\n"));

  /* referenced via xml2agOptions.pzFullVersion */
  puts(_("xml2ag (GNU AutoGen) 5.17.4"));

  /* referenced via xml2agOptions.pzFullUsage */
  puts(_("<<<NOT-FOUND>>>"));

  /* referenced via xml2agOptions.pzShortUsage */
  puts(_("<<<NOT-FOUND>>>"));
