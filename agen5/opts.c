...
/*  2721 */ "no-load-opts\0"
/*  2734 */ "AUTOGEN\0"
/*  2742 */ "autogen (GNU AutoGen) - The Automated Program Generator - Ver. 5.18.1\n"
...
/*  3124 */ "autogen (GNU AutoGen) 5.18.1\0"
/*  3153 */ "nothing\0"
...
doOptOverride_Tpl(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 178 */
...
doOptLib_Template(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 202 */
    templ_t * tpl;
...
doOptShell(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 252 */
...
doOptSelect_Suffix(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 615 */
    char const * arg = pOptDesc->optArg.argString;
    if ((arg != NULL) && (*arg != NUL))
        (void)do_suffix(arg, NULL, -1);
    (void)pOptions;
}
/* extracted from optmain.tlib near line 1267 */
